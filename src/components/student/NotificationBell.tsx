...
const StudentNotificationBell: React.FC<NotificationBellProps> = ({ className = '' }) => {
  ...
  return (
    <div className={`relative ${className}`}>
      ...
      >
        <Bell size={isMobile ? 16 : 20} color="#1f2937" /> {/* Reduced size for better proportions */}
          ...
          <div style={{
            ...
            {unreadCount > 0 && (
              <button
                ...
                style={{
                  background: isMobile ? 'rgba(59, 130, 246, 0.1)' : 'none',
                  border: isMobile ? '1px solid rgba(59, 130, 246, 0.2)' : 'none',
                  color: '#3b82f6',
